          ...
          {gallery.items.map(item => (
            ...
            >
              <div className="aspect-square bg-gray-100">
                ...
                item.media.mediaType === 'DUAL_VIDEO' ? (
              ...
              <div className="p-4">
                ...
                <div className="flex items-center justify-between text-xs text-gray-500">
                  <span>
                    {new Date(item.media.timestamp).toLocaleDateString()}
                  </span>
                  {item.media.location && (
        ...
        >
          ...
          >
            ...
            <div className="bg-white rounded-lg overflow-hidden">
              ...
              selectedItem.media.mediaType === 'DUAL_VIDEO' ? (
                <video
              ...
              <div className="p-4">
                ...
                <div className="flex items-center justify-between text-sm text-gray-500">
                  <span>
                    {new Date(selectedItem.media.timestamp).toLocaleString()}
                  </span>
                  <button
                    onClick={() =>
                      downloadImage(
