      ...
      <div className="min-h-screen flex" style={{ backgroundColor: '#0a0a0a' }}>
        ...
        <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden diamond-plate">
          ...
          <div className="absolute top-20 left-20 animate-lift">
            <IBeamCraneIcon
              className="h-32 w-32 text-safety-orange opacity-20"
              size={128}
            />
          </div>
          <div className="absolute bottom-20 right-20 animate-spark">
            <WeldingTorchIcon
              className="h-24 w-24 text-arc-flash-yellow opacity-20"
              size={96}
            />
          </div>
          ...
          <div className="relative z-10 flex flex-col justify-center px-12">
            <div className="space-y-6">
              <div className="flex items-center gap-4">
                <HardHatIcon
                  className="h-16 w-16 text-arc-flash-yellow"
                  size={64}
                />
          ...
          {showSparks && (
            <div className="absolute inset-0 pointer-events-none">
              <SparkAnimationIcon className="absolute top-1/4 left-1/3 h-16 w-16 text-arc-flash-yellow animate-spark" />
              <SparkAnimationIcon className="absolute bottom-1/3 right-1/4 h-12 w-12 text-safety-orange animate-spark" />
            </div>
          )}
        </div>
            ...
            <div className="brushed-metal rounded-lg shadow-2xl p-8 space-y-6">
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          aria-describedby={
                            error ? 'login-error email-help' : 'email-help'
                          }
                    ...
                    <div>
                      ...
                      <div id="password-help" className="sr-only">
                        Enter your account password. Use the eye icon to show or
                        hide password.
                      </div>
                    </div>
                  </div>
                  ...
                  {captchaChallenge && (
                    <div className="space-y-2">
                      ...
                      <p className="text-xs text-gray-400">
                        Multiple failed attempts detected. Please solve this
                        simple math problem.
                      </p>
                    </div>
                  )}
                      ...
                      {isLoading ? (
                        <>
                          <Loader2
                            ...
                            aria-hidden="true"
                          />
                          <span id="login-status" aria-live="polite">
                            {loadingMessage}
                          </span>
                        </>
                      ) : (
              ...
              <div className="text-center space-y-3">
                ...
                <div className="flex items-center justify-center gap-6 text-xs text-gray-500">
                  ...
                  <div className="text-center">
                    <p className="text-lg font-bold text-arc-flash-yellow">
                      5K+
                    </p>
                    <p>Photos</p>
                  </div>
