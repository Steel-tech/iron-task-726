  ...
  const features = [
    {
      ...
      description:
        'Capture and organize photos & videos of construction progress with location tagging.',
    },
    {
      icon: Shield,
      title: 'Safety Compliance',
      description:
        'OSHA-compliant documentation with real-time incident reporting and tracking.',
    },
    {
      icon: IronworkersTeamIcon,
      title: 'Team Management',
      description:
        'Track worker activities, certifications, and union status in one place.',
    },
    {
      icon: ProjectDrawingsIcon,
      title: 'Project Tracking',
      description:
        'Monitor multiple construction projects with timeline views and progress reports.',
    },
    {
      icon: Clock,
      title: 'Real-time Updates',
      description:
        'Instant notifications and live progress updates from the field.',
    },
    {
      icon: Cloud,
      title: 'Cloud Storage',
      description:
        'Secure cloud backup with offline capabilities for job site use.',
    },
  ]
    ...
    <div className="min-h-screen" style={{ backgroundColor: '#0a0a0a' }}>
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute top-20 left-10 animate-lift opacity-20">
            <IBeamCraneIcon
              className="h-64 w-64 text-safety-orange"
              size={256}
            />
          </div>
          <div className="absolute bottom-20 right-10 animate-tighten opacity-20">
            <WeldingTorchIcon
              className="h-48 w-48 text-arc-flash-yellow"
              size={192}
            />
          </div>
          {showSparks && (
            <>
              <SparkAnimationIcon className="absolute top-1/3 right-1/4 h-24 w-24 text-arc-flash-yellow animate-spark" />
              <SparkAnimationIcon className="absolute bottom-1/2 left-1/3 h-16 w-16 text-safety-orange animate-spark" />
            </>
          )}
        </div>
        ...
        <div className="relative z-10 px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          <div className="max-w-7xl mx-auto text-center">
            <div className="flex justify-center mb-8">
              <HardHatIcon
                className="h-24 w-24 text-arc-flash-yellow arc-weld-glow rounded-full"
                size={96}
              />
            </div>
            ...
            <p className="text-lg text-gray-400 mb-12 max-w-2xl mx-auto">
              Built by ironworkers, for ironworkers. Document your projects,
              ensure safety compliance, and track progress with the most trusted
              platform in steel construction.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/demo">
                <Button
                  size="lg"
                  className="bg-safety-orange hover:bg-orange-700 text-white font-bold px-8 py-4 text-lg arc-weld-glow"
                >
              ...
              <Link href="/register">
                <Button
                  variant="outline"
                  size="lg"
                  className="border-gray-400 bg-white text-black hover:bg-gray-100 hover:text-black hover:border-gray-300 px-8 py-4 text-lg"
                >
                  Start Free Trial
      ...
      <div className="relative py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-shogun text-white mb-4">
              Built for Steel Construction
            </h2>
            <p className="text-lg text-gray-400">
              Everything you need to document and manage construction projects
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <div
                key={index}
                className="brushed-metal rounded-lg p-6 hover:shadow-[0_0_20px_rgba(0,114,206,0.5)] transition-all duration-300"
              >
      ...
      <div className="relative py-16 bg-gray-900/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-shogun text-white mb-4">
              Enterprise-Grade Security
            </h2>
            <p className="text-lg text-gray-400">
              Your construction data is protected with industry-leading security
              standards
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-400 text-sm">
                Automated backups with 99.9% uptime
              </p>
            </div>
          </div>
                ...
                <div className="bg-gray-800 rounded-lg overflow-hidden">
                  ...
                  <div className="aspect-video bg-gradient-to-br from-gray-700 to-gray-900 flex items-center justify-center relative">
                    <div className="text-center">
                      <div className="mb-4">
                        <svg
                          className="h-16 w-16 text-safety-orange mx-auto"
                          fill="none"
                          viewBox="0 0 24 24"
                          stroke="currentColor"
                        >
                      ...
                      <p className="text-gray-400 text-sm">
                        See how Iron Task streamlines your documentation
                        workflow
                      </p>
                    </div>
                    {/* Play button overlay */}
            ...
            <div className="space-y-8">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400">
                    Capture and organize construction photos with automatic
                    location tagging and progress tracking.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400">
                    Track project progress with detailed analytics and automated
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400">
                    Keep your entire crew connected with real-time updates and
              ...
              <div className="pt-4 space-y-3">
                <Link href="/demo">
                  <Button
                    size="lg"
                    className="bg-safety-orange hover:bg-orange-700 text-white"
                  >
                    Try Interactive Demo
                    <ArrowRight className="h-5 w-5 ml-2" />
                  </Button>
                ...
                <p className="text-gray-400 text-sm">
                  No registration required • See it in action
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="relative py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-400">
              Choose the plan that fits your construction team
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <div className="brushed-metal rounded-lg p-8 relative">
              <div className="text-center">
                <h3 className="text-2xl font-shogun text-white mb-4">
                  Starter
                </h3>
                <div className="mb-6">
                  <span className="text-4xl font-bold text-safety-orange">
                    $29
                  </span>
            ...
            <div className="brushed-metal rounded-lg p-8 relative border-2 border-safety-orange">
              <div className="absolute -top-3 left-1/2 transform -translate-x-1/2">
                <span className="bg-safety-orange text-black px-4 py-1 rounded-full text-sm font-bold">
                  Most Popular
                </span>
              </div>
              <div className="text-center">
                ...
                <Button className="w-full bg-safety-orange hover:bg-orange-700 text-white">
                  Get Started
                </Button>
              </div>
            </div>
            ...
            <div className="brushed-metal rounded-lg p-8 relative">
              <div className="text-center">
                ...
                <Button className="w-full bg-aisc-blue hover:bg-blue-700 text-white">
                  Contact Sales
                </Button>
              </div>
            </div>
          ...
          <div className="text-center mt-12">
            ...
            <p className="text-gray-500 text-sm">
              ...
              <Link
                href="/contact"
                className="text-safety-orange hover:text-orange-400"
              >
                Contact us
              </Link>{' '}
              for custom pricing.
      ...
      <div className="relative py-24">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <CraneHookAnimationIcon
            className="h-20 w-20 text-aisc-blue mx-auto mb-8 animate-lift"
            size={80}
          />
          ...
          <div className="mt-12 space-y-4">
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link href="/register">
                <Button
                  size="lg"
                  className="bg-aisc-blue hover:bg-blue-700 text-white font-bold px-8 py-4 text-lg"
                >
                  Start Free Trial
                  <ArrowRight className="h-5 w-5 ml-2" />
                </Button>
            ...
            <p className="text-gray-400 text-sm">
              No credit card required for demo or trial
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="relative py-20 bg-gradient-to-r from-gray-900 to-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            {/* Content */}
            <div>
              <h2 className="text-4xl font-shogun text-white mb-6">
                Take Iron Task to the Field
              </h2>
              <p className="text-xl text-gray-300 mb-6">
                Document projects on-site with our mobile app built specifically
              ...
              <div className="space-y-4 mb-8">
                ...
                <div className="flex items-center gap-3">
                  <CheckCircle className="h-6 w-6 text-safety-green flex-shrink-0" />
                  <span className="text-gray-300">
                    Auto GPS tagging for exact locations
                  </span>
                </div>
                <div className="flex items-center gap-3">
                  <CheckCircle className="h-6 w-6 text-safety-green flex-shrink-0" />
                  <span className="text-gray-300">
                    Voice notes and quick annotations
                  </span>
                </div>
                <div className="flex items-center gap-3">
                  <CheckCircle className="h-6 w-6 text-safety-green flex-shrink-0" />
              ...
              <div className="mt-6 p-4 bg-gray-800/50 rounded-lg">
                <p className="text-gray-300 text-sm">
                  <span className="font-semibold text-arc-flash-yellow">
                    Coming Soon:
                  </span>{' '}
                  Scan this QR code with your phone to get notified when the
                  mobile app launches.
                </p>
              </div>
            </div>
                ...
                <div className="w-full h-full bg-gray-800 rounded-2xl overflow-hidden relative">
                  ...
                  <div className="bg-gradient-to-b from-gray-700 to-gray-900 h-full flex flex-col items-center justify-center">
                    <div className="text-center">
                      ...
                      <h3 className="text-white font-shogun text-lg mb-2">
                        Iron Task Mobile
                      </h3>
                      <p className="text-gray-400 text-sm px-6">
                        Field-ready construction documentation
                      </p>
      ...
      <div className="relative py-16 bg-gray-900/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-400">
              Our construction experts are here to help you succeed
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-safety-orange text-lg font-bold mb-2">
                (720) 555-IRON
              </p>
            ...
            <div className="text-center">
              ...
              <p className="text-aisc-blue text-lg font-bold mb-2">
                support@irontask.com
              </p>
            ...
            <div className="text-center">
              ...
              <p className="text-arc-flash-yellow text-lg font-bold mb-2">
                Available Now
              </p>
          ...
          <div className="text-center mt-12">
            <p className="text-gray-400 mb-4">
              Want to schedule a personalized demo?
            </p>
            <Button
              size="lg"
