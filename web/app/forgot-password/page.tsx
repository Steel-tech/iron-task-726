    ...
    <div className="min-h-screen flex items-center justify-center" style={{ backgroundColor: '#0a0a0a' }}>
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-20 left-10 animate-spark opacity-20">
          <SparkAnimationIcon className="h-32 w-32 text-arc-flash-yellow" size={128} isAnimating={true} />
        </div>
        ...
        <div className="brushed-metal rounded-lg shadow-2xl p-8 space-y-6">
          {isSuccess ? (
            <div className="text-center space-y-4">
              ...
              <h2 className="text-2xl font-shogun text-white">Check Your Email</h2>
              <p className="text-gray-400">
                We&apos;ve sent password reset instructions to <span className="text-arc-flash-yellow">{email}</span>
              </p>
            ...
            <>
              <div className="text-center">
                <h2 className="text-2xl font-shogun text-white">Reset Your Password</h2>
