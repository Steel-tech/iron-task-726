    ...
    return (
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <h1 className="text-2xl font-bold text-white mb-2">Report Generating...</h1>
          <p className="text-gray-400 mb-8">
            Your report is being generated by AI. This usually takes 30-60 seconds.
          </p>
          <Button variant="outline" onClick={() => router.push(`/dashboard/projects/${projectId}/reports`)}>
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
            ...
            <div>
              ...
              <div className="flex items-center gap-4 text-sm text-gray-400">
                <span className="flex items-center gap-1">
                  ...
                  {format(new Date(report.generatedAt || report.createdAt), 'MMMM d, yyyy')}
                </span>
                <span className="flex items-center gap-1">
          ...
          <div className="border-t pt-4">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
              ...
              <div>
                ...
                <p className="text-white font-medium">#{report.project.jobNumber}</p>
              </div>
              <div>
      ...
      <div className="space-y-8">
        ...
        {report.reportType === 'PROGRESS_RECAP' && content.sections?.map((section, index) => (
              ...
              <div className="bg-gray-800 rounded-lg p-6">
                ...
                <div className="space-y-3">
                  {content.highlights.map((highlight, index) => (
                    <div key={index} className="border-l-4 border-safety-orange pl-4">
        ...
        {report.reportType === 'DAILY_LOG' && (
          <>
            {content.workCompleted && content.workCompleted.length > 0 && (
              <div className="bg-gray-800 rounded-lg p-6">
                <h2 className="text-lg font-semibold text-white mb-4">Work Completed Today</h2>
                <div className="space-y-4">
                  {content.workCompleted.map((work, index) => (
                    <div key={index} className="border-l-2 border-gray-600 pl-4">
                      <div className="flex items-start justify-between">
                        <div>
                          <p className="text-white font-medium">{work.activity}</p>
            ...
            {report.todoItems && report.todoItems.length > 0 && (
              <div className="bg-gray-800 rounded-lg p-6">
                <h2 className="text-lg font-semibold text-white mb-4">Tomorrow&apos;s Action Items</h2>
                <div className="space-y-3">
...
function renderSectionContent(section: any) {
          ...
          <div key={index}>
            ...
            <div className="space-y-2">
              {dateGroup.activities.map((activity: any, actIndex: number) => (
                <div key={actIndex} className="text-sm text-gray-300 pl-4 border-l-2 border-gray-600">
                  <span className="font-medium">{activity.type}:</span> {activity.description}
                  <div className="text-xs text-gray-400 mt-1">
                    By {activity.user} {activity.location && `at ${activity.location}`}
                  </div>
                </div>
              ))}
            </div>
  ...
  return <pre className="text-gray-300 text-sm">{JSON.stringify(content, null, 2)}</pre>
}