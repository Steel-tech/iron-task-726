  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-gray-400">
            Select a form to complete for this project
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {/* Iron Task Form */}
        <div
          className="brushed-metal rounded-lg shadow-lg p-6 hover:bg-gray-700/50 transition-colors cursor-pointer group"
        ...
        >
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-gray-400 mb-4">
                Comprehensive safety harness inspection checklist including
                visual, functional testing, and compliance documentation.
              </p>
              <div className="flex flex-col gap-2 text-sm text-gray-400">
                <div className="flex items-center gap-2">
                  <div className="w-2 h-2 bg-safety-orange rounded-full"></div>
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-yellow-200 text-sm">
              ...
              Complete forms accurately and submit promptly to ensure project
