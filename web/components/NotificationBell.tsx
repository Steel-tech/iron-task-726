...
import { Bell, X, MessageCircle, AtSign, ThumbsUp, AlertTriangle } from 'lucide-react'
                    ...
                    >
                      <div className="flex gap-3">
                        <div className={`flex-shrink-0 p-2 rounded-full ${
                          !notification.read ? 'bg-safety-orange/20' : 'bg-gray-700'
                        }`}>
                          <Icon className={`h-4 w-4 ${
                            !notification.read ? 'text-safety-orange' : 'text-gray-400'
                          }`} />
                        </div>
