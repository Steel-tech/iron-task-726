...
import { AlertTriangle, Camera, Users, Clock, MapPin, FileText, Plus, X } from 'lucide-react'
...
export default function FSWIncidentReport({ projectId }: FSWIncidentReportProps) {
  ...
  const addWitness = () => {
    setFormData(prev => ({
      ...prev,
      witnesses: [...prev.witnesses, { name: '', role: '', contactInfo: '', statement: '' }]
    }))
  }
    ...
    <div className="max-w-4xl mx-auto">
      <div className="brushed-metal rounded-lg shadow-lg p-8">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h2 className="text-2xl font-bold font-shogun text-white">Incident Report</h2>
            <p className="text-gray-400">Near-miss and accident reporting with investigation details</p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-white border-b border-gray-700 pb-2">Report Information</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-300 mb-2">Reporter Role *</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-sm font-medium text-gray-300 mb-2">Report Date *</label>
                <input
                  type="date"
          ...
          {/* Incident Details */}
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-white border-b border-gray-700 pb-2">Incident Details</h3>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => setFormData({ ...formData, incidentType: e.target.value as IncidentReportData['incidentType'] })}
                  className="w-full px-3 py-2 bg-gray-800 border border-gray-700 rounded text-white text-sm focus:outline-none focus:ring-2 focus:ring-safety-orange"
                  required
                >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-300 mb-2">Specific Location</label>
                <input
                  type="text"
          ...
          {formData.incidentType === 'injury' && (
            <div className="space-y-4">
              <h3 className="text-lg font-semibold text-white border-b border-gray-700 pb-2">Injured Person Details</h3>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  <label className="block text-sm font-medium text-gray-300 mb-2">Injured Person Name *</label>
                  <input
                    type="text"
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setFormData({ ...formData, injuredPersonRole: e.target.value })}
                    className="w-full px-3 py-2 bg-gray-800 border border-gray-700 rounded text-white text-sm focus:outline-none focus:ring-2 focus:ring-safety-orange"
                    required={formData.incidentType === 'injury'}
                  />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-300 mb-2">Employer</label>
                  <input
                    type="text"
                    value={formData.injuredPersonEmployer}
                    onChange={(e) => setFormData({ ...formData, injuredPersonEmployer: e.target.value })}
                    className="w-full px-3 py-2 bg-gray-800 border border-gray-700 rounded text-white text-sm focus:outline-none focus:ring-2 focus:ring-safety-orange"
                  />
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <div>
                  <label className="block text-sm font-medium text-gray-300 mb-2">Body Part Affected</label>
                  <input
                    type="text"
                    value={formData.injuryDetails.bodyPart}
                    onChange={(e) => setFormData({ 
                      ...formData, 
                      injuryDetails: { ...formData.injuryDetails, bodyPart: e.target.value } 
                    })}
                    className="w-full px-3 py-2 bg-gray-800 border border-gray-700 rounded text-white text-sm focus:outline-none focus:ring-2 focus:ring-safety-orange"
                  />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-300 mb-2">Injury Type</label>
                  <input
                    type="text"
                    value={formData.injuryDetails.injuryType}
                    onChange={(e) => setFormData({ 
                      ...formData, 
                      injuryDetails: { ...formData.injuryDetails, injuryType: e.target.value } 
                    })}
                    className="w-full px-3 py-2 bg-gray-800 border border-gray-700 rounded text-white text-sm focus:outline-none focus:ring-2 focus:ring-safety-orange"
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => setFormData({ 
                      ...formData, 
                      injuryDetails: { ...formData.injuryDetails, severity: e.target.value as InjuryDetails['severity'] } 
                    })}
                    className="w-full px-3 py-2 bg-gray-800 border border-gray-700 rounded text-white text-sm focus:outline-none focus:ring-2 focus:ring-safety-orange"
                    required={formData.incidentType === 'injury'}
                  >
                ...
                <div className="flex items-center pt-8">
                  <label className="flex items-center text-sm text-gray-300">
                    <input
                      ...
                      onChange={(e) => setFormData({ 
                        ...formData, 
                        injuryDetails: { ...formData.injuryDetails, medicalAttention: e.target.checked } 
                      })}
              ...
              {formData.injuryDetails.medicalAttention && (
                <div>
                  <label className="block text-sm font-medium text-gray-300 mb-2">Medical Provider/Facility</label>
                  <input
                    type="text"
                    value={formData.injuryDetails.medicalProvider}
                    onChange={(e) => setFormData({ 
                      ...formData, 
                      injuryDetails: { ...formData.injuryDetails, medicalProvider: e.target.value } 
                    })}
                    className="w-full px-3 py-2 bg-gray-800 border border-gray-700 rounded text-white text-sm focus:outline-none focus:ring-2 focus:ring-safety-orange"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setFormData({ ...formData, temperatureF: e.target.value })}
                  className="w-full px-3 py-2 bg-gray-800 border border-gray-700 rounded text-white text-sm focus:outline-none focus:ring-2 focus:ring-safety-orange"
                />
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-300 mb-2">Work Conditions</label>
                <input
                  type="text"
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <h3 className="text-lg font-semibold text-white border-b border-gray-700 pb-2">Witnesses</h3>
              <Button
                type="button"
                size="sm"
                variant="outline"
            ...
            {formData.witnesses.map((witness, index) => (
              <div key={index} className="bg-gray-800/50 p-4 rounded-lg">
                <div className="flex justify-between items-center mb-3">
                  <h4 className="text-white font-medium">Witness {index + 1}</h4>
                  <Button
                    type="button"
                    size="sm"
                    variant="outline"
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-3">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => updateWitness(index, 'contactInfo', e.target.value)}
                      className="w-full px-3 py-2 bg-gray-700 border border-gray-600 rounded text-white text-sm focus:outline-none focus:ring-2 focus:ring-safety-orange"
          ...
          {/* Contributing Factors */}
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-white border-b border-gray-700 pb-2">Contributing Factors</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              {contributingFactorOptions.map((factor) => (
                <label key={factor} className="flex items-center text-sm text-gray-300">
                  <input
                    type="checkbox"
                    checked={formData.contributingFactors.includes(factor)}
                    onChange={(e) => handleContributingFactorChange(factor, e.target.checked)}
                    className="mr-2 rounded border-gray-700 bg-gray-800 text-safety-orange focus:ring-2 focus:ring-safety-orange"
                  />
                  {factor}
                </label>
            ...
            <div>
              <label className="block text-sm font-medium text-gray-300 mb-2">Equipment Involved</label>
              <input
                type="text"
          ...
          {/* PPE Information */}
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-white border-b border-gray-700 pb-2">Personal Protective Equipment</h3>
            <div>
              <label className="block text-sm font-medium text-gray-300 mb-2">PPE Used at Time of Incident</label>
            ...
            <div>
              <label className="block text-sm font-medium text-gray-300 mb-2">PPE Condition</label>
              <textarea
                value={formData.ppeCondition}
                onChange={(e) => setFormData({ ...formData, ppeCondition: e.target.value })}
                rows={2}
                className="w-full px-3 py-2 bg-gray-800 border border-gray-700 rounded text-white text-sm focus:outline-none focus:ring-2 focus:ring-safety-orange"
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-white border-b border-gray-700 pb-2">Prevention & Follow-up</h3>
            <div>
              <label className="block text-sm font-medium text-gray-300 mb-2">Recommended Prevention Measures</label>
              <textarea
            ...
            {formData.followupRequired && (
              <div>
                <label className="block text-sm font-medium text-gray-300 mb-2">Follow-up Details</label>
                <textarea
          ...
          {/* Evidence */}
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-white border-b border-gray-700 pb-2">Evidence & Documentation</h3>
            <div className="flex items-center">
              <label className="flex items-center text-sm text-gray-300">
                <input
                  type="checkbox"
                  checked={formData.photosNeeded}
                  onChange={(e) => setFormData({ ...formData, photosNeeded: e.target.checked })}
                  className="mr-2 rounded border-gray-700 bg-gray-800 text-safety-orange focus:ring-2 focus:ring-safety-orange"
                />
            ...
            <div>
              ...
              <textarea
                ...
                onChange={(e) => setFormData({ ...formData, evidenceCollected: e.target.value })}
                rows={2}
                className="w-full px-3 py-2 bg-gray-800 border border-gray-700 rounded text-white text-sm focus:outline-none focus:ring-2 focus:ring-safety-orange"
          ...
          {/* Signatures */}
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-white border-b border-gray-700 pb-2">Signatures & Review</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium text-gray-300 mb-2">Reporter Signature *</label>
                <input
                  type="text"
