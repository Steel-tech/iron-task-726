...
export default function ProgressAnalyticsDashboard() {
  ...
  useEffect(() => {
    ...
    const mockActivityTrends: ActivityTrend[] = Array.from(
      { length: 30 },
      (_, i) => ({
  ...
  const calculateProjectHealth = (project: ProjectProgress) => {
    ...
    const budgetHealth =
      100 - (project.budget.spent / project.budget.allocated) * 100
    const safetyHealth = project.safetyScore
    const teamHealth = (project.team.active / project.team.assigned) * 100

    return Math.round(
      (progressHealth + budgetHealth + safetyHealth + teamHealth) / 4
    )
  }
                  ...
                  <div className="flex items-center justify-between mb-3">
                    <div>
                      ...
                      <p className="text-sm text-gray-500">
                        {project.team.active} of {project.team.assigned} team
                        members active
                      </p>
                    </div>
                  ...
                  <div className="mt-4">
                    ...
                    <div className="flex gap-1">
                      {project.phases.map((phase, index) => (
                        ...
                        >
                          <div
                            className={`absolute inset-0 ${getPhaseStatusColor(phase.status)} opacity-20`}
                          />
                          <div
            ...
            <div className="h-48 flex items-end justify-between gap-1">
              {activityTrends.slice(-14).map((trend, index) => {
                const maxValue = Math.max(
                  ...activityTrends.map(t => t.teamActivity)
                )
                  ...
                  >
                    <div className="flex flex-col gap-1 w-full">
                      ...
                      <div
                        ...
                        style={{
                          height: `${(trend.safetyChecks / 10) * 20}px`,
                        }}
                      ...
                      <div
                        ...
                        style={{
                          height: `${(trend.progressUpdates / 8) * 15}px`,
                        }}
