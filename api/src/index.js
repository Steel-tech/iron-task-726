...
const { logger, requestCorrelationMiddleware, errorLoggingMiddleware } = require('./utils/logger');
const { 
  httpsEnforcement, 
  securityHeaders, 
  requestValidation, 
...
fastify.register(require('./routes/filters').sharedCatalogRoute, { prefix: '/api' });
// Push notifications
