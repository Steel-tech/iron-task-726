...
async function routes(fastify, options) {
  ...
  fastify.post(
    '/register',
    {
      preHandler: [authRateLimit, validate(authSchemas.register)],
    },
    async (request, reply) => {
      const {
        email,
  ...
  fastify.post(
    '/login',
    {
      preHandler: [authRateLimit, validate(authSchemas.login)],
    },
    async (request, reply) => {
      ...
      try {
        ...
        const {
          ...
          twoFactorSecret: removedTwoFactorSecret,
          twoFactorBackupCodes: removedTwoFactorBackupCodes,
  ...
  fastify.post(
    '/change-password',
    {
      preHandler: [fastify.authenticate, validate(authSchemas.changePassword)],
    },
    async (request, reply) => {
