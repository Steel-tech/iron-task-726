...
async function main() {
  ...
  for (const userData of users) {
    const user = await prisma.user.upsert({
      ...
      create: {
        ...
        phoneNumber: '(303) 555-01' + Math.floor(Math.random() * 100).toString().padStart(2, '0')
      }
    });
  ...
  console.log('\n📝 Test credentials:');
  console.log('  Email: admin@fsw-denver.com | Password: Test1234! | Role: Admin');
  console.log('  Email: pm@fsw-denver.com | Password: Test1234! | Role: Project Manager');
  console.log('  Email: foreman@fsw-denver.com | Password: Test1234! | Role: Foreman');
  console.log('  Email: worker@fsw-denver.com | Password: Test1234! | Role: Worker');
}
