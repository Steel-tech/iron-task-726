...
describe('Auth Middleware', () => {
  ...
  describe('authorizeOwnership', () => {
    ...
    it('should deny access for non-owner', async () => {
      ...
      expect(mockReply.code).toHaveBeenCalledWith(403);
      expect(mockReply.send).toHaveBeenCalledWith({ error: 'Access denied to this resource' });
    });
  });
  ...
  describe('authorizeProject', () => {
    ...
    it('should deny access for non-member', async () => {
      ...
      expect(mockReply.code).toHaveBeenCalledWith(403);
      expect(mockReply.send).toHaveBeenCalledWith({ error: 'Not a member of this project' });
    });
  });
  ...
  describe('requireActiveUser', () => {
    ...
    it('should deny inactive users', async () => {
      ...
      expect(mockReply.code).toHaveBeenCalledWith(403);
      expect(mockReply.send).toHaveBeenCalledWith({ error: 'User account not found or inactive' });
    });
  });
});