...
jest.mock('../../src/services/tokenService', () => ({
  createRefreshToken: jest.fn(() => ({ token: 'mock-refresh-token', id: 'session-123' })),
...
jest.mock('zod', () => ({
  z: {
    string: () => ({
      ...
      min: () => ({ max: () => mockSchema, regex: () => mockSchema, optional: () => mockSchema }),
      uuid: () => ({ optional: () => mockSchema }),
      regex: () => ({ min: () => ({ max: () => mockSchema, optional: () => mockSchema }) }),
      optional: () => mockSchema
    }),
    object: () => mockSchema,
    ...
    coerce: {
      number: () => ({ int: () => ({ positive: () => ({ default: () => mockSchema, max: () => ({ default: () => mockSchema }) }) }) })
    },
    any: () => mockSchema,
...
describe('Auth Routes', () => {
  ...
  describe('POST /auth/logout', () => {
    it('should logout user successfully', async () => {
      ...
      app.jwt.verify.mockImplementation(() => ({ id: '123', email: 'test@example.com' }));
